...
export function buildSystemPrompt(character, memoryContext) {
  ...
  const frame = RELATIONSHIP_FRAMES[character.relationship] || RELATIONSHIP_FRAMES.conociendose;
  ...
  return [
    ...
    'ESTILO:',
    '- Respuestas de 1 a 4 frases, como chat real. Emojis con moderación y naturalidad.',
